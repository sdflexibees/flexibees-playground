    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveSmallIntegerField(choices=[(1, 'Scheduled'), (2, 'In Review'), (3, 'Selected'), (4, 'Rejected'), (5, 'Position Filled Rejected'), (6, 'Notification Sent')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operations_in', models.CharField(choices=[('1', 'Domestic'), ('2', 'International')], default='1', max_length=3)),
                ('longitude', models.FloatField(null=True)),
                ('latitude', models.FloatField(null=True)),
                ('is_active', models.BooleanField(default=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('country', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='admin_app.country')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pricing_currency', models.CharField(choices=[('1', 'INR'), ('2', 'USD')], default='1', max_length=2)),
                ('is_active', models.BooleanField(default=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('candidate_slots', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='common.candidateinterviewslot')),
                ('interview', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='employer.interview')),
            ],
            options={
